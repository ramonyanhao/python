...
while True:
    ...
    try:
        ...
        print("来自客户端%s,发送的%s" % (client, receive_data.decode('utf-8')))  # 打印接收的内容
        message='您发送的消息:%s'%receive_data.decode('utf8')
        server_socket.sendto(message.encode('utf8'),client)
